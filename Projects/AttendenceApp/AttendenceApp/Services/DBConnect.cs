...
namespace AttendenceApp.Services
{
    class DBConnect
    {
        ...
        {
            server = server_ip;
            //server = "127.0.0.1";//server_ip //Main Server: "192.168.30.252" //My Laptop Server ip: 127.0.0.1
            database = "brotecshrm";
            uid = "root";
            password = ps;
            //password = "brotecs1230";//ps //Main Server Has no pass //My Pc Server Pass: "brotecs1230"
            port = 3306;
            dbDebug = debug;
        ...
        private void Initialize()
        {
            ...
            //connectionString = "server=192.168.30.152;user id=root;database=brotecshrm";
            connectionString = "SERVER=" + server + ";" + "PORT=" + port + ";" + "DATABASE=" + database + ";" + "UID=" + uid + ";" + "PASSWORD=" + password + ";";
            //connectionString = "SERVER=" + server + ";" + "DATABASE=" + database + ";" + "UID=" + uid + ";" + "PASSWORD=" + password + ";";
            // dbLog = new LogFile(dbLogFilePath + "/// dbLog.log", true, LogFile.LogType.TXT, LogFile.LogLevel.All);
