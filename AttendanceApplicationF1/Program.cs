...
using AttendanceApplicationF1.Models;
using AttendanceApplicationF1.Services;
using System;
...
namespace AttendanceApplicationF1
{
    class Program
    {
        class FingerPrintDataCollector
        {
            ...
            private static void readConfiguration()
            {
                ...
                if(!File.Exists(settingFilename))
                {
                    ...
                    iniHandler.Write("serverIP", "192.168.30.105", "db_settings");
